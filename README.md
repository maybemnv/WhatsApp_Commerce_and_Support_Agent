...
The current slice covers normalized inbound identity, replay deduplication, workspace scoping, service-window opening, inbox/detail APIs, product facts, quantity confirmation, payment-link idempotency, and the browser demo surface.
...
- Next: PostgreSQL repository, service-window enforcement at outbound submission, approved-template registry, opt-out/takeover gates, retry/dead-letter state, and live adapter capability checks.
